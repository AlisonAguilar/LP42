...
switch ($caso){
    case 'mgabinete':
        mgabinete($method,$route,$params,$data,$headers);
        break;
    case 'mgabineteReportes':
        mgabineteReportes($method,$route,$params,$data,$headers);
        break;
    case 'mpersonas':
        mpersonas($method,$route,$params,$data,$headers);
        break;
    case 'mpersonasReportes':
        mpersonasReportes($method,$route,$params,$data,$headers);
        break;
}

function mgabinete($method,$route,$params,$data,$headers){
    $html = '';
    $html.='<div class="pagetitle">
      <h1>Gestión de Gabinetes</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.html">Inicio</a></li>
          <li class="breadcrumb-item">Gabinetes</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-4">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Registrar Gabinete</h5>

              <!-- General Form Elements -->
              <form id="frmGabinete" name="frmGabinete">
                <div class="row mb-3">
                  <label for="nombreGabinete" class="col-sm-4 col-form-label">Gabinete: </label>
                  <div class="col-sm-8">
                    <input type="text" class="form-control" id="nombreGabinete" name="nombreGabinete">
                  </div>
                </div>
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-8">
                    <button type="submit" id="guardarGabinete" name="guardarGabinete" class="btn btn-primary">Guardar</button>
                    <input type="hidden" id="caso" name="caso" value="guardarGabinete">
                    <input type="hidden" id="idgabinete" name="idgabinete" value="0">
                  </div>
                </div>
        ...
        <div class="col-lg-8">
          ...
          <div class="card">
            <div class="card-body">              
                    ...
                    <div class="row">
                        <div class="col-lg-12">                        
                            <h5 class="card-title">Gabinetes Existentes</h5>                                       
                                        <!-- Table with stripped rows -->
                                        <table class="display table datatable" id="tbl_gabinetes" name="tbl_gabinetes" style="width:100%">
                                            <thead>
                                            <tr>
                                                <th>N.</th>
                                                <th><b>N</b>ombre</th>
                                            ...
                                            <tbody>';
                                            //require dirname(__DIR__,2)."\Routes\gabinete.php";
                                             $app = new gabineteController($method,$route,$params,$data,$headers);
                                             $data = $app->getAll('form');
                                             $i = 1;
                                             //print_r($data);
                                             foreach ($data as $key => $value) {
                                                ...
                                                $html.='<tr>
                                                          ...
                                                          <td><button type="button" class="btn btn-success"  onclick="editarGabinete('.$value['id_gabinete'].');"><i class="bi bi-pencil-square"></i></button>
                                                          <button type="button" class="btn btn-danger"  onclick="eliminarGabinete('.$value['id_gabinete'].');"><i class="bi bi-trash"></i></button></td>
                                                      </tr>';
                                                      $i++;
                                             }
                                            $html.='</tbody>
                    ...
                    </section><script>new DataTable("#tbl_gabinetes");</script>
            </div>
          </div>
...
function mgabineteReportes($method,$route,$params,$data,$headers){
    $html='';
    $html.='<div class="pagetitle">
      <h1>Data Tables</h1>
      <nav>
    ...
    <script>new DataTable("#tbl_gabinetes");</script>';

    echo $html;
}

function mpersonas($method,$route,$params,$data,$headers){
    $html = '';
    $html.='<div class="pagetitle">
      <h1>Form Elements</h1>
      <nav>
...
function mpersonasReportes($method,$route,$params,$data,$headers){
    $html='';
    $html.='<div class="pagetitle">
      <h1>Data Tables</h1>
      <nav>
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- Table with stripped rows -->
              <table class="display table datatable" id="tbl_personas" name="tbl_personas" style="width:100%">
                <thead>
                  <tr>
                    <th>
                      <b>N</b>ame
    ...
    </section><script>new DataTable("#tbl_personas");</script>';
