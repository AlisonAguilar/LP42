...
<head>
  ...
  <link href="/api-rest-composer-0800/src/Views/assets/css/style.css" rel="stylesheet">
   ...
   <link href="/api-rest-composer-0800/src/Views/css/dataTables.css" rel="stylesheet">
...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="index.html" class="logo d-flex align-items-center">
        ...
        <span class="d-none d-lg-block">Gabinete XYZ</span>
      </a>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#components-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-menu-button-wide"></i><span>Gabinete</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a style="cursor:pointer;" id="mgabinete" name="mgabinete">
              <i class="bi bi-circle"></i><span>Gabinetes</span>
            </a>
          </li>
          <li>
            <a style="cursor:pointer;" id="mgabineteReportes" name="mgabineteReportes">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#forms-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-journal-text"></i><span>Personas</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a style="cursor:pointer;" id="mpersonas" name="mpersonas">
              <i class="bi bi-circle"></i><span>Gestionar Personas</span>
            </a>
          </li>
          <li>
            <a style="cursor:pointer;" id="mpersonasReportes" name="mpersonasReportes">
              <i class="bi bi-circle"></i><span>Reportes</span>
            </a>
          </li>  
        </ul>
  ...
  <main id="main" name="main" class="main">
  ...
  <script src="/api-rest-composer-0800/src/Views/js/dataTables.js"></script>
